        ...
        <>
            ...
            {!isEmptyActivities ? (
                activities.map( activity => (
                    <div key={activity.id} className="px-5 py-10 bg-white mt-5 flex justify-between rounded-lg shadow">
                ...
                <p className="text-center my-3 font-medium text-2xl">No hay actividades</p>
            )}
